...
/**
 * Implements the abstract {@link storj.StorageAdapter#_flush}
 * @private
 * @param {Function} callback
 */
MongoAdapter.prototype._flush = function(callback) {
  // NB: Bridge does not store data shards, so there is no reason to flush
  // NB: as having this as unimplemented would throw an unimplemented error.
